...
const azul = new Book("Azul","Ruben Dario", "Azul... es un libro de cuentos y poemas del poeta nicaragüense Rubén Darío, considerada una de las obras más relevantes del modernismo hispánico. ", "1888","/img/rubendario.jpg");
const poemas = new Book("Poemas","Edgar Allan Poe","","", "/img/poemasEdgar.jpg");
